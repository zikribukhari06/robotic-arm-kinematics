# 🤖 Manipulator robot kinematics

![Robot Demo](media/demo.gif) <!-- Taruh GIF gerak robot atau render 3D di paling atas -->

## Projek ini adalah perancangan robot manipulator sebagai media pembelajaran kinematika gerak dari robot melalui tugas besar matakuliah robotika

#### -- proses perancangan kinematika robot

dalam perancangan kinematika robot, terdapat 2 proses dalam perancangannya. yaitu forward kinematics dan invers kinematics

##### 1. Forward Kinematics(FK)

_forward kinematic_ merupakan proses perhitungan koordinat lokasi dari ujung robot dalam sumbu X,Y,Z berdasarkan nilai input sudut yang diberikan $\theta_1$, $\theta_2$, $\theta_3$, $\theta_n$.

##### 2. Invers Kinematics(IK)
